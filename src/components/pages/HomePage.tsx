    ...
    <div className="space-y-10 py-8">
      ...
      <section id="services" className="space-y-4 scroll-mt-24">
        <div className="flex items-end justify-between gap-3">
          ...
          {!!topServices[0]?.slug && (
            <a className="link" href="/categories">ดูหมวดสินค้าทั้งหมด →</a>
          )}
        </div>
      ...
      <section id="locations" className="space-y-4 scroll-mt-24">
        <div className="flex items-end justify-between gap-3">
          ...
          {!!topLocations[0]?.slug && (
            <a className="link" href="/locations">ดูทั้งหมด →</a>
          )}
        </div>
      ...
      <section className="card overflow-hidden">
        <div className="grid md:grid-cols-2 gap-0">
          {/* Image side */}
          <div className="relative h-64 min-h-[16rem] md:min-h-[28rem]">
            <img
              src="/images/staff-laptop.webp"
