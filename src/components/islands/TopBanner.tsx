...
export function TopBanner() {
  ...
  return (
    <div
      className="relative overflow-hidden bg-gradient-to-r from-emerald-500 via-emerald-400 to-teal-500 animate-slideIn"
    ...
    >
      ...
      <div
        className="absolute top-1/2 right-20 h-32 w-32 rounded-full bg-white/10 blur-2xl animate-float"
        ...
        <div className="flex items-center justify-between gap-4 py-3 sm:py-4">
          <div className="flex flex-1 items-center gap-3 sm:gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 text-white">
                ...
                <span className="hidden sm:inline-block rounded-full bg-white/20 backdrop-blur px-3 py-1 text-xs font-bold">
                  ส่งรูปเพื่อประเมิน
                </span>
              </div>
              <div className="text-xs sm:text-sm text-white/90 mt-0.5">
                ...
                <span className="hidden sm:inline"> • ประเมินตามข้อมูลและสภาพ • นัดรับตามพื้นที่</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              data-track-cta="true"
              data-cta-channel="line"
              data-cta-label="Top banner LINE"
              className="inline-flex items-center gap-2 rounded-full bg-white px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-bold text-emerald-600 shadow-lg transition-all hover:scale-105 hover:shadow-xl"
            >
