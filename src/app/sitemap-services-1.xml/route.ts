/**
 * Sitemap services segment 1 — /sitemap-services-1.xml (400 แรก)
 */
...
/** segment 1 = 4 หน้า ~8s; segment มากกว่านั้นต้อง skip ใช้เวลานาน — ปรับใน env ได้ */
...
export async function GET() {
  ...
  try {
    const entries = await Promise.race([getServicesEntriesForSegment(0), timeoutPromise]);
